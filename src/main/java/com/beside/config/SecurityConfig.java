...
//    private List<String> allowedOriginPaths;
    ...
    @PostConstruct
    public void init() {
        allowedOriginPaths = Arrays.asList("http://localhost:5173", "https://dev-mountains-after-mountains.vercel.app", "https://over-the-mountain.site", "https://www.over-the-mountain.site");
    }
